...
This repo is an AMI builder for the LAN/WIFI bastions. It runs on a schedule on the 1st of every month to keep our bastions patached.
It can also be run manually via workflow dispatch on the GitHub console.

## How to run locally

`packer build -var "deploy_to_all_environments=False" .`
